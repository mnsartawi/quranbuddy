...
function DropdownMenu({
  ...
  return (
    <DropdownMenuContext.Provider value={{ open, onOpenChange: handleOpenChange, exiting }}>
      ...
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ctx?.exiting
            ...
            : "data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-open:fill-mode-backwards data-[state=open]:duration-200",
