...
function Select({
  ...
  const onOpenChangeRef = React.useRef(onOpenChangeProp)
  ...
  return (
    <SelectContext.Provider value={{ open, onOpenChange: handleOpenChange, exiting }}>
      ...
      <SelectPrimitive.Content
        ...
        className={cn(
          ctx?.exiting
            ...
            : "data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-open:fill-mode-backwards data-[state=open]:duration-300",
          ...
          position === "popper" &&
            "h-(--radix-select-trigger-height) w-full min-w-(--radix-select-trigger-width) data-[side=bottom]:translate-y-1 data-[side=left]:-translate-x-1 data-[side=right]:translate-x-1 data-[side=top]:-translate-y-1",
          className
        )}
        position={position}
        align={align}
